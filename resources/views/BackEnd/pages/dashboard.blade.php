         ...
         <div class="panel height2">
             ...
             <div class="panel-body">
                 <ul class="app-downloads">
                     <li>
                         <p class="clearfix"><i class="icon-appleinc text-danger"></i>IOS<span>5769</span></p>
                     ...
                     <li>
                         <p class="clearfix"><i class="icon-android text-warning"></i>Android<span>2126</span></p>
                         <div class="progress progress-md">
                     ...
                     <li>
                         <p class="clearfix"><i class="icon-windows8 text-success"></i>Windows<span>1068</span></p>
                         <div class="progress progress-md">
                     ...
                     <li>
                         <p class="clearfix"><i class="icon-download5 text-info"></i>Blackberry<span>285</span></p>
                         <div class="progress progress-md">
                 ...
                 <div class="panel height2">
                     ...
                     <div class="panel-body">
                         <ul class="transactions">
                             <li><a href="javascript:void(0)"><span class="tra-icon"><i class="icon-shield3 text-danger"></i> </span><span class="tra-type">Month Salary</span> <span class="tra-amount text-success">+7250</span></a></li>
                             <li><a href="javascript:void(0)"><span class="tra-icon"><i class="icon-aircraft text-success"></i> </span><span class="tra-type">Trip to Venice</span> <span class="tra-amount text-danger">-1100</span></a></li>
                             <li><a href="javascript:void(0)"><span class="tra-icon"><i class="icon-shopping-cart text-info"></i> </span><span class="tra-type">Shopping</span> <span class="tra-amount text-danger">-1890</span></a></li>
                             <li><a href="javascript:void(0)"><span class="tra-icon"><i class="icon-bowl text-warning"></i> </span><span class="tra-type">Lunch at work</span> <span class="tra-amount text-danger">-1250</span></a></li>
                             <li><a href="javascript:void(0)"><span class="tra-icon"><i class="icon-pig text-danger"></i> </span><span class="tra-type">Money left</span> <span class="tra-amount text-success">+9650</span></a></li>
                         </ul>
                     </div>
                 </div>
             </div>
