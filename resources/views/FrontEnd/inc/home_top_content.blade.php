		...
		<div class="row">
			<div class="col-lg-8 pr-0">
				<div class="ts-overlay-style featured-post featured-post-style">
					<div class="item" style="background-image:url({{asset('public/FrontEnd')}}/images/news/travel/travel3.jpg)">
			...
			<div class="col-lg-4 ts-grid-style-3 featured-post p-1">
				<div class="ts-overlay-style ">
					<div class="item" style="background-image: url({{asset('public/FrontEnd')}}/images/news/fashion/fashion5.jpg);">
				...
				<!-- ts overly end-->
				<div class="ts-overlay-style">
					<div class="item" style="background-image: url({{asset('public/FrontEnd')}}/images/news/sports/sports2.jpg);">
